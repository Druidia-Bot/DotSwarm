...
- v2 is the swarm architecture: the coordinator (Codex) supervises, a DeepSeek Harness Agent Team works. v1 (the consultation companion) lives on the `v1` branch and is not referenced here.
