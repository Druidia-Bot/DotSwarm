...
test('folds team events into roster, tasks, mail, tokens, and errors', () => {
  ...
  assert.deepEqual(s.tokens(), { input: 110, output: 55, cacheRead: 0 });
  assert.deepEqual(s.tokensByMember(), { lead: { input: 100, output: 50, cacheRead: 0 }, worker: { input: 10, output: 5, cacheRead: 0 } });
